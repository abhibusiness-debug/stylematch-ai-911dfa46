...
const GEMINI_IMAGE_MODELS = ["gemini-2.0-flash-exp-image-generation", "gemini-2.0-flash-exp"];
const LOVABLE_IMAGE_MODELS = ["google/gemini-3.1-flash-image-preview", "google/gemini-3-pro-image-preview"];
